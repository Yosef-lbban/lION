...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/yousef_labban1")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/Mhsliem15bot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/yousef_labban1")]])
