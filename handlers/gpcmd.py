...
###############
  if text:
    ...
    if rank != "admin":
      ...
      if re.search("^حذف الصورة$|^حذف الصورة$", text):
      ...
      if re.search("^الاوامر المضافة$",text):
        tx = "الاوامر المضافة ℹ️:\n"
...
<a href=\"https://t.me/yousef_labban/\">𝖫ꫀOn</a>
[𝖫ꫀOn](https://t.me/yousef_labban/)
